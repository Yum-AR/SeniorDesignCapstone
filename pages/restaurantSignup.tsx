                ...
                <div>
                    <div>
                        ...
                        <p className="mt-1 max-w-2xl text-sm text-gray-500">
                            Please fill out the form below with all of your restaurant details. We will get back to you within 3 business days.
                        </p>
                    </div>
                            ...
                            <div className="mt-1 max-w-lg sm:mt-0 sm:col-span-2">
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        name="username"
                                        id="fullName"
                                        className="shadow-sm p-2 focus:ring-indigo-500 bg-gray-50 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        name="email"
                                        id="email"
                                        className="shadow-sm p-2 bg-gray-50 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                            ...
                            <div className="mt-1 max-w-lg sm:mt-0 sm:col-span-2">
                                ...
                                <div className="mt-1">
                                    ...
                                    {...register('phoneNumber')}
                                        ...
                                        name="phoneNumber"
                                        id="phoneNumber"
                                        className="shadow-sm bg-gray-50 p-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
