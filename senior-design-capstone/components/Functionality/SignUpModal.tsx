              ...
              <div>
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="items-center text-center pt-3 text-md leading-6 text-gray-700">Already have an account? <a onClick={showLoginForm}>Log in here</a></div>
                    <div className="relative">
                    ...
                    <div className="items-center text-center pt-3 text-md leading-6 text-gray-700">Or, sign up as a <a className="font-semibold" href="/restaurantSignup.html">Restaurant Owner here</a></div>
                  </div>
                </div>
              </div>
            </div>
